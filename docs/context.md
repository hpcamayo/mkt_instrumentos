...
- Sprint 4 is **CLOSED / ACCEPTED**: the owner reported all eight remaining production cases PASS on 2026-09-17 (`REV-014`, `PHOTO-015`, `AUTH-023`, `WA-001`–`WA-004`, `SANA-010`). Sprint 5 production source is `516bf4591512b99748f14795f384e594143d1268`; matching migration and automated production verification completed on 2026-09-18. Sprint 5 owner usability acceptance remains pending; see `docs/sprint-5-production-verification.md`.
