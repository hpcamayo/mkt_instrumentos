...
- Sprints 1–6 are **CLOSED / ACCEPTED**. Sprint 6 production source is `9ea8e88a342edc4fb54d873e85974d576e42863f`; the owner accepted `TX-013` and `REVW-020` on 2026-09-20. Sprint 7 is implemented and fully verified locally only; no production migration, deployment, provider secret or cron configuration has occurred.
...
- `/mi-cuenta/alertas`: local Sprint 7 owner-scoped exact saved searches with Immediate/Daily frequency and pause/resume/delete.
...
Acceptance process: `acceptance/cases.tsv` is canonical and `acceptance/sprints.tsv` is the selective retrieval guide. Read only exact current-sprint IDs/domain prefixes, preserve unrelated rows/IDs, and validate TSV changes. Do not read or regenerate XLSX until the final V1 freeze gate. Sprint 6 owner evidence is closed; Sprint 7 browser/inbox cases remain blocked until the separate production release and owner pass.
