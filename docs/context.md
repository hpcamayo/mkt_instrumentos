...
- Sprints 1–5 are **CLOSED / ACCEPTED**. Sprint 5 production source is `516bf4591512b99748f14795f384e594143d1268`; its matching migration/release passed automation and the owner accepted the remaining cases on 2026-09-18. Sprint 6 is implemented and verified locally only; migration `20260918120000_sprint_6_transactions_reviews.sql` is not deployed. See `docs/sprint-5-production-verification.md` and `docs/sprint-6-verification.md`.
...
- `/mi-cuenta/transacciones` and `/mi-cuenta/transacciones/[id]`: local Sprint 6 participant-scoped purchase/sale confirmation, history and immutable review flow.
