...
export function HeroSection() {
  return (
    <section
      className="relative isolate overflow-hidden bg-laria-black py-16 text-white sm:py-20 lg:py-24"
      style={{
        backgroundImage:
          "linear-gradient(90deg, rgba(5,6,8,0.98) 0%, rgba(5,6,8,0.88) 40%, rgba(5,6,8,0.34) 100%), url('https://images.unsplash.com/photo-1501386761578-eac5c94b800a?auto=format&fit=crop&w=2400&q=80')",
